...
def read_tweets_from_json():
    ...
    answer = input("Y/N ")
    if answer == "Y":
#        json_files_list = ["Output Files/June2019/16_3_WiredSussex_followers_freelance-tagged_3200-first_half.json","Output Files/June2019/16_3_WiredSussex_followers_freelance-tagged_3200-second_half.json"]
        json_files_list = ["2020-03-17_2020-03-10-1.json"]
